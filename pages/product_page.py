...
class ProductPage(BasePage):
    ...
    def should_equal_product_name_in_cart(self):
        ...
        print(Product_name, Product_name_in_cart)  

    def should_equal_product_price_in_cart(self):
        ...
        assert Product_price == Cart_price, "Product name not equal"
        print(Product_price, Cart_price)  
